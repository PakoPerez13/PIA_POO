...
/////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//Se crea un archivo para los productos de las funciones que estén disponibles
	void CrearArchivoBoletos(){
		try {
			
		      File Boletos = new File("Peliculas.txt");
		      if (Boletos.createNewFile()) {
		        System.out.println("Archivo creado: " + Boletos.getName());
		        DeclararGerente();
				DeclararCajeroDul();
				DeclararCajeroBol();
		      } else {
