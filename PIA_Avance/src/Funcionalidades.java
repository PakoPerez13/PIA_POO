...
/////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void AgregarGanancia() {
		System.out.println("Actualice el ingreso que desea añadir\n");
		System.out.println("Nuevo Ingreso: \n");
		
		try {
			BufferedWriter bw = new BufferedWriter(new FileWriter("Ganancias.txt", true));
			bw.write("");
			bw.close();
		} catch (IOException e) {
			e.printStackTrace();
		...
		AñadirGa("Nuevo ingreso", Scan.nextFloat());
		System.out.println("El monto fue guardado con exito");
	}
	
	void AgregarPago() {
		System.out.println("Actualice el pago que se ha generado");
		System.out.println("Nuevo pago: \n");
		
		try {
			BufferedWriter bw = new BufferedWriter(new FileWriter("Pagos.txt", true));
			bw.write("");
			bw.close();
		} catch (IOException e) {
			e.printStackTrace();
		...
		AñadirPa("Nuevo pago", Scan.nextFloat());
		System.out.println("El monto fue guardado con exito");
	}
